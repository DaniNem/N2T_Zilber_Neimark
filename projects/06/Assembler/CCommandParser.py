class CCommandParser(object):
    ...
    def __init__(self):
        ...
        self.comp = {"0": "110101010", "1": "110111111", "-1": "110111010",
                     ...
                     "D-A": "110010011",
                     "D-M": "111010011", "A-D": "110000111",
                     "M-D": "111000111",
                     "D&A": "110000000", "D&M": "111000000",
                     "D|A": "110010101",
                     "D|M": "111010101", "D<<": "010110000",
                     "D>>": "010010000",
                     "A<<": "010100000", "A>>": "010000000",
                     "M<<": "011100000",
                     "M>>": "011000000"
                     }
        self.dest = {"null": "000", "": "000", "M": "001", "D": "010",
                     "MD": "011",
                     "A": "100", "AM": "101", "AD": "110", "AMD": "111"}
        self.jump = {"null": "000", "": "000", "JGT": "001", "JEQ": "010",
                     "JGE": "011",
                     "JLT": "100", "JNE": "101", "JLE": "110", "JMP": "111"}

    def run(self, lst, table={}):
        """
        go over the lines and replace the c instructions with their binary
        form
